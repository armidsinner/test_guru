...
var _sorting_type = /*#__PURE__*/_classPrivateFieldLooseKey("sorting_type");
...
var Sorting = /*#__PURE__*/function () {
  function Sorting(id, sorting_type) {
    ...
    Object.defineProperty(this, _sorting_type, {
      writable: true,
      value: void 0
    });
    _classPrivateFieldLooseBase(this, _id)[_id] = id;
    _classPrivateFieldLooseBase(this, _sorting_type)[_sorting_type] = sorting_type;
  }

  _createClass(Sorting, [{
    key: "sort_table",
    value: function sort_table() {
      element_id = _classPrivateFieldLooseBase(this, _id)[_id];
      sorting_type = _classPrivateFieldLooseBase(this, _sorting_type)[_sorting_type];
...
/******/ });
//# sourceMappingURL=sorting-8d790505b6e1719958e4.js.map