...
var EditTitle = /*#__PURE__*/function () {
  ...
  _createClass(EditTitle, [{
    ...
    value: function set_control() {
      ...
      controls.forEach(function (elem) {
        elem.addEventListener('click', function (event) {
          return _this2.formInLineLinkHandler(event, elem);
        });
      }); // for (let i = 0; i < controls.length; i++) {
      //   controls[i].addEventListener('click', function() { formInLineLinkHandler(controls[i]) } )
      // }
      //.preventDefault()
    ...
    value: function formInLineLinkHandler(event, elem) {
      ...
      var testId = elem.dataset.testId;
...
/******/ });
//# sourceMappingURL=application-f3be174d974d737bc798.js.map