...
var Check_confirmation = /*#__PURE__*/function () {
  ...
  _createClass(Check_confirmation, [{
    ...
    value: function setControl(element_to_compare_with, compering_element) {
      ...
      var control = document.getElementById("check-coincidence"); // в любом виде выдается ошибка is not a function. Даже так, но при этом 
      //если передавать функцию как в прошлых ПР, все работает

      if (control) control.addEventListener('input', function () {
        _this.userInputCheck(element_to_compare_with, compering_element);
      });
    }
  }, {
    key: "userInputCheck",
    value: function userInputCheck(element_to_compare_with, compering_element) {
      ...
      if (confirmation.value) {
        if (user_input.value === confirmation.value) {
          (function () {
            _this2.inform_about_considense(user_input, confirmation, match, notMatch);
          });
        }

        if (user_input.value !== confirmation.value) {
          (function () {
            _this2.inform_about_nonconsidense(user_input, confirmation, match, notMatch);
          });
        }
      }
      ...
      if (confirmation.value.length === 0) {
        (function () {
          _this2.while_user_input_is_absent(user_input, confirmation, match, notMatch);
        });
      }
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-0e86cc0f6883bbbc9f81.js.map