...
var Check_confirmation = __webpack_require__(/*! ./check_confirmation.js */ "./app/javascript/packs/check_confirmation.js");
...
document.addEventListener('turbolinks:load', function () {
  var controls = document.querySelectorAll('.form-inline-link'); // use forEach
...
function formInlineHandler(testId) {
  ...
  var testTitle = document.querySelector('.test-title-link[data-test-id="' + testId + '"]');
  ...
  if (testTitle.classList.contains('hide')) {
...
/******/ });
//# sourceMappingURL=application-b55fb99c959cacfe9a35.js.map