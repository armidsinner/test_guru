  ...
  _createClass(Check_confirmation, [{
    ...
    value: function compare() {
      ...
      document.addEventListener('turbolinks:load', function () {
        ...
        if (control) control.addEventListener('input', get_inform(element_to_compare_with, compering_element));
      });

      function get_inform(element_to_compare_with, compering_element) {
        var _this = this;
    ...
    value: function userInputCheck(element_to_compare_with, compering_element) {
      ...
      if (confirmation.value) {
        if (user_input.value === confirmation.value) {
          ...
          (function () {
            _this2.inform_abouy_nonconsidense(user_input, confirmation, match, notMatch);
          });
        }
      } else {
        (function () {
...
compare_passwords = new Check_confirmation('user_password', 'user_password_confirmation');
compare_passwords.compare();

/***/ })

/******/ });
//# sourceMappingURL=check_password_coincidence-32a5b93bc7f6cdf9e513.js.map