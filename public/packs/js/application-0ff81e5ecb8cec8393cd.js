...
var Check_confirmation = /*#__PURE__*/function () {
  ...
  _createClass(Check_confirmation, [{
    ...
    value: function setControl(element_to_compare_with, compering_element) {
      ...
      console.log(compering_element);
      var control = document.getElementById("check-coincidence");
      if (control) control.addEventListener('input', this.userInputCheck(a, b));
    }
  }, {
    key: "userInputCheck",
...
/******/ });
//# sourceMappingURL=application-0ff81e5ecb8cec8393cd.js.map