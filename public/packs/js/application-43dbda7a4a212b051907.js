...
var countdown_timer = new _countdown_js__WEBPACK_IMPORTED_MODULE_8__["Timer"]();
...
document.addEventListener('turbolinks:load', function () {
  ...
  if (timer) {
    ...
    countdown_timer.set_timer(url, timer, timeLeft);
  }
});
...
var Timer = /*#__PURE__*/function () {
  function Timer(timer, url, timeLeft) {
  ...
  _createClass(Timer, [{
    key: "set_timer",
    value: function set_timer(url, timer) {
      var _this = this;

      setInterval(function () {
        return _this.interval_ongoing(url, timer);
      }, 1000);
    }
  }, {
    key: "interval_ongoing",
    value: function interval_ongoing(url, timer) {
      if (this.timeLeft <= 0) {
    ...
    key: "change_timer",
    value: function change_timer(timer) {
...
/******/ });
//# sourceMappingURL=application-43dbda7a4a212b051907.js.map