...
var Check_confirmation = /*#__PURE__*/function () {
  function Check_confirmation(first_element_to_compare_id, second_element_to_compare_id, check_type) {
  ...
  _createClass(Check_confirmation, [{
    ...
    value: function compare() {
      ...
      document.addEventListener('turbolinks:load', function () {
        ...
        if (control) {
          control.addEventListener('input', userInputCheck);
        }
      });

      function userInputCheck() {
        var user_input = document.getElementById(id1);
...
/******/ });
//# sourceMappingURL=application-937641b49983e12b69f8.js.map