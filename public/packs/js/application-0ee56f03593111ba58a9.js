      ...
      function userInputCheck() {
        ...
        if (confirmation.value) {
          if (user_input.value === confirmation.value) {
            (function () {
              _this.inform_about_considense(_this.user_input, _this.confirmation, _this.match, _this.notMatch);
            });
          }
        ...
        if (confirmation.value.length === 0) {
          (function () {
            _this.while_user_input_is_absent(_this.user_input, _this.confirmation, _this.match, _this.notMatch);
          });
        }
      }
    }
...
/******/ });
//# sourceMappingURL=application-0ee56f03593111ba58a9.js.map