...
document.addEventListener('turbolinks:load', function () {
  ...
  if (timer) {
    var _countdown_timer = new _countdown_js__WEBPACK_IMPORTED_MODULE_8__["Timer"](timer);

    _countdown_timer.set_timer();
  }
});
...
var Timer = /*#__PURE__*/function () {
  ...
  _createClass(Timer, [{
    ...
    value: function set_timer() {
      ...
      var url = this.timer.dataset.url;
      setInterval(function () {
        return _this.interval_ongoing(url);
      }, 1000);
    }
  }, {
    key: "interval_ongoing",
    value: function interval_ongoing(url) {
      if (this.timeLeft <= 0) {
    ...
    value: function change_timer() {
      ...
      this.timer.innerHTML = "\u0412\u0440\u0435\u043C\u044F \u0434\u043E \u043E\u043A\u043E\u043D\u0447\u0430\u043D\u0438\u044F \u0442\u0435\u0441\u0442\u0430: ".concat(minutes, ":").concat(seconds);
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-43a9981c81b9137f939f.js.map