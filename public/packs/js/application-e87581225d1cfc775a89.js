...
Object(_rails_ujs__WEBPACK_IMPORTED_MODULE_0__["$"])(document).on('ready turbolinks:load', edit_title.edit_title());
    ...
    value: function set_control() {
      ...
      controls.forEach(function (control) {
        control.addEventListener('click', function (event) {
          return _this2.formInLineLinkHandler(event, control);
        });
      });
...
/******/ });
//# sourceMappingURL=application-e87581225d1cfc775a89.js.map