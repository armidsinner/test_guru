...
var EditTitle = /*#__PURE__*/function () {
  function EditTitle() {
    ...
    this.formInLineLinkHandler = function (event) {
      event.preventDefault();
      var testId = event.dataset.testId;

      _this.formInLineHandler(testId);
    };
  }
    ...
    value: function set_control() {
      ...
      var _loop = function _loop(i) {
        controls[i].addEventListener('click', function () {
          return _this3.formInLineLinkHandler(controls[i]);
        });
      };
...
/******/ });
//# sourceMappingURL=application-6d81f4660dd5e2c3638b.js.map