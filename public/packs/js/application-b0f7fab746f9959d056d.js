  ...
  _createClass(EditTitle, [{
    ...
    value: function set_control() {
      ...
      for (var i = 0; i < controls.length; i++) {
        controls[i].addEventListener('click', this.formInLineLinkHandler(controls[i]));
        console.log(this.formInLineLinkHandler(controls[i]));
      } //.preventDefault()
...
/******/ });
//# sourceMappingURL=application-b0f7fab746f9959d056d.js.map