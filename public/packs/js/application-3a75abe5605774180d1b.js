  ...
  _createClass(Sorting, [{
    ...
    value: function setControl(sorting_type, element_id) {
      ...
      if (control) control.addEventListener('click', function () {
        return _this2.sortRowsByTitle(element_id, control);
      });
    }
  }, {
    key: "sortRowsByTitle",
    value: function sortRowsByTitle(element_id, control) {
      ...
      if (control.querySelector('.octicon-arrow-up').classList.contains('hide')) {
        console.log(control.querySelector('.octicon-arrow-up').classList);
        control.sort(this.compareRowsAsc);
...
/******/ });
//# sourceMappingURL=application-3a75abe5605774180d1b.js.map