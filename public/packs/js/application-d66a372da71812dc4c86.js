    ...
    value: function userInputCheck(element_to_compare_with, compering_element) {
      ...
      if (confirmation.value) {
        if (user_input.value === confirmation.value) {
          (function () {
            return _this3.inform_about_considense(user_input, confirmation, match, notMatch);
          });
        }

        if (user_input.value !== confirmation.value) {
          (function () {
            return _this3.inform_about_nonconsidense(user_input, confirmation, match, notMatch);
          });
        }
      }
      ...
      if (confirmation.value.length === 0) {
        (function () {
          return _this3.while_user_input_is_absent(user_input, confirmation, match, notMatch);
        });
      }
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-d66a372da71812dc4c86.js.map