...
/* harmony import */ var _sorting_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sorting.js */ "./app/javascript/packs/sorting.js");
/* harmony import */ var _check_confirmation_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./check_confirmation.js */ "./app/javascript/packs/check_confirmation.js");
/* harmony import */ var _form_inline_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./form_inline.js */ "./app/javascript/packs/form_inline.js");
/* harmony import */ var _progress_bar_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./progress_bar.js */ "./app/javascript/packs/progress_bar.js");
/* harmony import */ var _countdown_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./countdown.js */ "./app/javascript/packs/countdown.js");
...
var timer = new _countdown_js__WEBPACK_IMPORTED_MODULE_8__["Timer"]();
var sorted_table = new _sorting_js__WEBPACK_IMPORTED_MODULE_4__["Sorting"]('table', "sort-by-title");
var bar = new _progress_bar_js__WEBPACK_IMPORTED_MODULE_7__["ProgressBar"]();
var compare_passwords = new _check_confirmation_js__WEBPACK_IMPORTED_MODULE_5__["CheckConfirmation"]('user_password', 'user_password_confirmation');
var edit_title = new _form_inline_js__WEBPACK_IMPORTED_MODULE_6__["EditTitle"]();
document.addEventListener('turbolinks:load', function () {
  compare_passwords.compare();
  edit_title.edit_title();
  sorted_table.sort_table();
  bar.add_progress_bar();
  setInterval(timer.set_timer(), 1000);
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckConfirmation", function() { return CheckConfirmation; });
  ...
  _createClass(CheckConfirmation, [{
    ...
    value: function compare() {
      ...
      if (control) control.addEventListener('input', function () {
        return _this.userInputCheck(element_to_compare_with, compering_element);
      });
    }
  }, {
    key: "userInputCheck",
...
var Timer = /*#__PURE__*/function () {
  ...
  _createClass(Timer, [{
    key: "set_timer",
    value: function set_timer() {
      var timer = document.querySelector('.timer');
      var timeLeft = timer.dataset.timer * 60;
      var url = timer.dataset.url;
      setInterval(this.interval_ongoing(timeLeft, url, timer), 1000);
    }
  }, {
    key: "interval_ongoing",
    value: function interval_ongoing(timeLeft, url, timer) {
      var ending = timer.dataset.ended; //  if (ending !== false){
      //  window.location.href = url
      // }

      timeLeft--;
      this.change_timer(timeLeft, timer);
    }
  }, {
    key: "change_timer",
    value: function change_timer(timeLeft, timer) {
      var minutes = Math.floor(timeLeft / 60);
      var seconds = timeLeft % 60;
      timer.innerHTML = "\u0412\u0440\u0435\u043C\u044F \u0434\u043E \u043E\u043A\u043E\u043D\u0447\u0430\u043D\u0438\u044F \u0442\u0435\u0441\u0442\u0430 ".concat(minutes, ":").concat(seconds);
    }
  }]);
...
/*!*********************************************!*\
  !*** ./app/javascript/packs/form_inline.js ***!
  \*********************************************/
/*! exports provided: EditTitle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditTitle", function() { return EditTitle; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var EditTitle = /*#__PURE__*/function () {
  ...
  _createClass(EditTitle, [{
    ...
    value: function edit_title() {
      ...
      controls.forEach(function (control) {
        control.addEventListener('click', function (event) {
          return _this.formInLineLinkHandler(event, control);
        });
      });
    ...
    value: function formInLineLinkHandler(event, control) {
      event.preventDefault();
      var testId = control.dataset.testId;
      this.formInLineHandler(testId);
    }
  }, {
    key: "formInLineHandler",
    value: function formInLineHandler(testId) {
...
var ProgressBar = /*#__PURE__*/function () {
  ...
  _createClass(ProgressBar, [{
    key: "add_progress_bar",
    value: function add_progress_bar() {
      var control = document.getElementById('progress-bar');
      if (control) this.showCurrentProgress(control);
    }
  }, {
    key: "showCurrentProgress",
    value: function showCurrentProgress(control) {
...
/******/ });
//# sourceMappingURL=application-d9391403f53e1aaf7e5d.js.map