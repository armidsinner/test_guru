...
var Check_confirmation = /*#__PURE__*/function () {
  function Check_confirmation(first_element_to_compare_id, second_element_to_compare_id) {
    ...
    this.userInputCheck = function () {
      ...
      if (confirmation.value) {
        if (user_input.value === confirmation.value) {
          inform_about_considense();
        } else {
          inform_abouy_nonconsidense();
        }
      } else {
        while_user_input_is_absent();
      }

      return this;
    };

    this.inform_abouy_nonconsidense = function () {
      match.add('hide');
    ...
    this.inform_about_considense = function () {
      match.remove('hide');
      notMatch.add('hide');
    ...
    this.while_user_input_is_absent = function () {
      match.add('hide');
      notMatch.add('hide');
      user_input.classList.remove('border-orange');
      confirmation.classList.remove('border-orange');
...
/******/ });
//# sourceMappingURL=check_password_coincidence-23fc3b391db0900eca5d.js.map