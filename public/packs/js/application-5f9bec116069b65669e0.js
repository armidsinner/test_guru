...
/* harmony import */ var _check_confirmation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./check_confirmation.js */ "./app/javascript/packs/check_confirmation.js");
/* harmony import */ var _sorting_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./sorting.js */ "./app/javascript/packs/sorting.js");
...
var compare_passwords = new _check_confirmation_js__WEBPACK_IMPORTED_MODULE_4__["CheckConfirmation"]('user_password', 'user_password_confirmation');
compare_passwords.compare();

var sorted_table = new _sorting_js__WEBPACK_IMPORTED_MODULE_5__["Sorting"]('table', "sort-by-title");
...
var EditTitle = /*#__PURE__*/function () {
  ...
  _createClass(EditTitle, [{
    ...
    value: function edit_title() {
      ...
      document.addEventListener('turbolinks:load', function () {
        return _this.set_control();
      });
    }
  }, {
    key: "set_control",
    value: function set_control() {
      var _this2 = this;

      var controls = document.querySelectorAll('.form-inline-link');

      var _loop = function _loop(i) {
        var event = controls[i].addEventListener('click', function () {
          return _this2.formInLineLinkHandler(controls[i], event);
        });
        console.log(controls[i].addEventListener('click', _this2.formInLineLinkHandler(controls[i], event)));
      };
    ...
    value: function formInLineLinkHandler(event, elem) {
      elem.preventDefault();
      var testId = event.dataset.testId;
...
/******/ });
//# sourceMappingURL=application-5f9bec116069b65669e0.js.map