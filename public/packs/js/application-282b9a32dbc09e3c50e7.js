...
var Check_confirmation = __webpack_require__(/*! ./check_password_coincidence.js */ "./app/javascript/packs/check_password_coincidence.js");

var compare_passwords = new Check_confirmation('user_password', 'user_password_confirmation');
compare_passwords.compare();

var Sorting = __webpack_require__(/*! ./sorting.js */ "./app/javascript/packs/sorting.js");

var sorted_table = new Sorting('table', "sort-by-title");
...
var Check_confirmation = /*#__PURE__*/function () {
  ...
  _createClass(Check_confirmation, [{
    ...
    value: function compare() {
      ...
      console.log(document.getElementsByClassName('check-field'));
      document.addEventListener('turbolinks:load', this.setControl(element_to_compare_with, compering_element));
    }
  }, {
    key: "setControl",
    value: function setControl(element_to_compare_with, compering_element) {
      var a = element_to_compare_with;
      var b = compering_element;
      console.log('set control');
      var control = document.getElementsByClassName('check-field');

      if (control) {
        control.addEventListener('input', this.userInputCheck(a, b));
      }
    }
  }, {
    key: "userInputCheck",
    value: function userInputCheck(element_to_compare_with, compering_element) {
      ...
      console.log(document.getElementById(element_to_compare_with));
      ...
      if (confirmation.value) {
        if (user_input.value === confirmation.value) {
          (function () {
            _this.inform_about_considense(user_input, confirmation, match, notMatch);
          });
        }

        if (user_input.value !== confirmation.value) {
          (function () {
            _this.inform_about_nonconsidense(user_input, confirmation, match, notMatch);
          });
        }
      }
      ...
      if (confirmation.value.length === 0) {
        (function () {
          _this.while_user_input_is_absent(user_input, confirmation, match, notMatch);
        });
      }
    }
  }, {
    key: "inform_abouy_nonconsidense",
    value: function inform_abouy_nonconsidense(user_input, confirmation, match, notMatch) {
      match.add('hide');
  ...
  _createClass(Sorting, [{
    ...
    value: function sort_table() {
      ...
      document.addEventListener('turbolinks:load', function () {
        ...
        if (control) {
          control.addEventListener('click', this.sortRowsByTitle(element_id));
        }
      });
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-282b9a32dbc09e3c50e7.js.map