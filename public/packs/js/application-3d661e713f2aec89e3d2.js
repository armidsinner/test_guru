...
var EditTitle = /*#__PURE__*/function () {
  ...
  _createClass(EditTitle, [{
    ...
    value: function set_control() {
      ...
      var _loop = function _loop(i) {
        controls[i].addEventListener('click', function () {
          return _this2.formInLineLinkHandler(controls[i], _this2);
        });
      };
    ...
    value: function formInLineLinkHandler(event, needed_thig) {
      (function () {
        return needed_thig.preventDefault();
      });
...
/******/ });
//# sourceMappingURL=application-3d661e713f2aec89e3d2.js.map