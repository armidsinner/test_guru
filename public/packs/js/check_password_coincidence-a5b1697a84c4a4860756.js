...
var Check_confirmation = /*#__PURE__*/function () {
  function Check_confirmation(first_element_to_compare_id, second_element_to_compare_id) {
    ...
    this.userInputCheck = function (element_to_compare_with, compering_element) {
    ...
    this.inform_about_considense = function (user_input, confirmation, match, notMatch) {
      match.remove('hide');
      notMatch.add('hide');
...
/******/ });
//# sourceMappingURL=check_password_coincidence-a5b1697a84c4a4860756.js.map